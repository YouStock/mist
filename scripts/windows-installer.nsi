...
Section "uninstall"
    ...
    #SimpleFC::AdvRemoveRule "Aura incoming peers (TCP:30303)"
    #SimpleFC::AdvRemoveRule "Aura outgoing peers (TCP:30303)"
    #SimpleFC::AdvRemoveRule "Aura UDP discovery (UDP:30303)"
